 ...
 * @param {Date} _nowDate Description
...
function Timeline(_date, _nowDate) {
    ...
    if (deltaTime <= HOURS3) {
        var _delta1 = deltaTime;
        if (_delta1 < MINUTES30) {
	    var _MINUTES=new Date(_delta1).getMinutes();
...
typeof module != 'undefined' ? module.exports = Timeline: this[Timeline] = Timeline;
